...
/**************************************************************************/
/* $Id: lang-german.php,v 1.1.1.1 2005/11/21 13:48:02 tropic Exp $ */
...
define("_CURRENCIES_NOT_FOUND","Währung not found");
define("_SHOPS_ONLINE","Shops Online");
define("_READ_MORE_NEWS","Read more News");
define("_SHOPS_NOT_FOUND","Shops not found");
define("_REVIEWS_NOT_FOUND","Reviews not found");
define("_PRODUCTS_NOT_FOUND","Product not found");
define("_GO_TO_SHOP","Zum Shop");
define("_DETAILS_VENDOR","Über diesen Shop");
define("_SOME_PRODUCTS","Einige unserer Produkte");
define("HEADER_CREATE_ACCOUNT","Kundenkonto erstellen");
define("HEADER_SUBMIT_NEWS","News schreiben");
define("HEADER_YOUR_ACCOUNT","Ihr Konto");
define("HEADER_CONTENT","Inhalt");
define("HEADER_TOPICS","Themen");
define("HEADER_ALL_TOPICS","Alle Themen");
define("HEADER_WELCOME","Welcome to");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Vendors");
define("_SELECT_VENDOR","Shop wählen");
define("_SELECT_CATEGORY","Kategorie wählen");
define("_VENDORS_NOT_FOUND","Shop nicht gefunden");
define("_CATEGORIES_NOT_FOUND","Kategorie nicht gefunden");
define("_PRODUCTS_NOT_FOUND","Artikel nicht gefunden");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","Free Software");
define("_LAST10DOWNLOAD","letzten 10 Downloads");
define("_SITE_PREFERENCES","Site Preferences for ");
define("_VENDORS","Shops");
define("_OUR_SHOPS","Unsere Shops");
define("_PRODUCTS","Produkte");
define("_CATEGORIES_PRODUCTS","Kategorien");
define("_DETAILS_PROD","Über diesen Artikel");
define("_PRODUCT_RANDOM","Vorschau");
define("_DEVELOPMENT","Projekt");
define ("_TEXT_NEWS", "<center><b>Entwicklung des Projekts</b></center><p>Auf dieser Seite sehen sie die Entwicklung der Projekete: modules, blocks, functionalities, etc... .</p>");
define("_SELECTCURRENCY","Währung");
