...
/**************************************************************************/
/* $Id: lang-italian.php,v 1.1.1.1 2005/11/21 13:48:03 tropic Exp $ */

/***************************/
/* new variables Multishop */
/***************************/
define("_TABLE_NOT_FOUND","Manca la seguente tabella");
define("_CURRENCIES_NOT_FOUND","Valute non presenti");
define("_SHOPS_ONLINE","Negozi Online");
define("_READ_MORE_NEWS","Leggi più notizie");
define("_SHOPS_NOT_FOUND","Non vi sono Negozi");
define("_REVIEWS_NOT_FOUND","Recensioni non trovate");
define("_PRODUCTS_NOT_FOUND","Prodotti non trovati");
define("_GO_TO_SHOP","Vai al Negozio");
define("_DETAILS_VENDOR","Particolari sul Negozio");
define("_SOME_PRODUCTS","Alcuni dei Nostri Prodotti");
define("HEADER_CREATE_ACCOUNT","Crea un Account");
define("HEADER_SUBMIT_NEWS","Invia una Notizia");
define("HEADER_YOUR_ACCOUNT","Il tuo Account");
define("HEADER_CONTENT","Contenuti");
define("HEADER_TOPICS","Argomenti");
define("HEADER_ALL_TOPICS","Tutti gli Argomenti");
define("HEADER_WELCOME","Benvenuto in");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Negozio");
define("_SELECT_VENDOR","Scegli il negozio");
define("_SELECT_CATEGORY","Scegli la Categoria");
define("_VENDORS_NOT_FOUND","Non sono presenti Negozi");
define("_CATEGORIES_NOT_FOUND","Non vi sono Categorie");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","Software Libero");
define("_LAST10DOWNLOAD","ultimi 10 Download");
define("_SITE_PREFERENCES","Prefernze per il sito ");
define("_VENDORS","Negozi");
define("_OUR_SHOPS","I Nostri Negozi");
define("_PRODUCTS","Prodotti");
define("_CATEGORIES_PRODUCTS","Categorie");
define("_DETAILS_PROD","Particolari sul Prodotto");
define("_PRODUCT_RANDOM","Un Prodotto a Caso");
define("_DEVELOPMENT","Sviluppo");
define ("_TEXT_NEWS", "<center><b>Sviluppo del Progetto</b></center><p>In questa pagina sono riportate le notizie riguardanti i nuovi moduli, i blocchi, le nuove funzionalità e tutto quel che riguarda l'evoluzione del progetto.</p>");
define("_SELECTCURRENCY","Scegli la Valuta");

/******************************/
/* orginal variables Php-Nuke */
/******************************/
