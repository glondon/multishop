...
/**************************************************************************/
/* $Id: lang-english.php,v 1.1.1.1 2005/05/27 12:51:22 tropic Exp $ */

/*****************************************/
/* new variables Multishop               */
/* Translation in Romanian by            */
/* Prislea - manole@romanians.nl         */
/*****************************************/
define("_TABLE_NOT_FOUND","The following table is missing");
define("_CURRENCIES_NOT_FOUND","Correncies not found");
define("_SHOPS_ONLINE","Shops Online");
define("_READ_MORE_NEWS","Read more News");
define("_SHOPS_NOT_FOUND","Stores not found");
define("_REVIEWS_NOT_FOUND","Reviews not found");
define("_PRODUCTS_NOT_FOUND","Products not found");
define("_GO_TO_SHOP","Go to the Store");
define("_DETAILS_VENDOR","About this Store");
define("_SOME_PRODUCTS","Some of Our Products");
define("HEADER_CREATE_ACCOUNT","Creeaza un Cont");
define("HEADER_SUBMIT_NEWS","Trimite Stiri");
define("HEADER_YOUR_ACCOUNT","Contul Dvs.");
define("HEADER_CONTENT","Continut");
define("HEADER_TOPICS","Topice");
define("HEADER_ALL_TOPICS","Toate Topicele");
define("HEADER_WELCOME","Bun venit la");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Vendors");
define("_SELECT_VENDOR","Selectati Magazin");
define("_SELECT_CATEGORY","Selectati o Categorie");
define("_VENDORS_NOT_FOUND","Nu am gasit Vanzatori");
define("_CATEGORIES_NOT_FOUND","Nu am gasit Categorii");
define("_PRODUCTS_NOT_FOUND","Nu am gasit Producte");
define("_HOME_DEMO","Pagina Principala Demo");
define("_FREE_SOFTWARE","Gratis Software");
define("_LAST10DOWNLOAD","ultimele 10 Descarcari");
define("_SITE_PREFERENCES","Preferintele pe Site pentru");
define("_VENDORS","Magazine Virtuale");
define("_OUR_SHOPS","Magazinele noastre Virtuale");
define("_PRODUCTS","Producte");
define("_CATEGORIES_PRODUCTS","Categorii");
define("_DETAILS_PROD","Despre acest Product");
define("_PRODUCT_RANDOM","Un Product la intamplare");
define("_DEVELOPMENT","Developare");
define ("_TEXT_NEWS", "<center><b>Developarea Proiectului</b></center><p>Pe aceasta pagina apare ultimele noutati despre  dezvoltarea acestui proiect: module, blocuri, functionalitatile, etc... .</p>");
define("_SELECTCURRENCY","Selectati o Valuta");

/*****************************************************/
/* original variables Php-Nuke                       */
/*****************************************************/
