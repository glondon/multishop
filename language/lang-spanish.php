...
/* $Id: lang-spanish.php,v 1.1.1.1 2005/11/21 13:48:03 tropic Exp $ */

/***************************/
/* new variables Multishop */
/***************************/
/* Translation by Roberto Del Pino · fexcel (http://www.pescoland.com) */
define("_TABLE_NOT_FOUND","La seguiente tabla no existe");
define("_CURRENCIES_NOT_FOUND","Monedas no encontradas");
define("_SHOPS_ONLINE","Tiendas Online");
define("_READ_MORE_NEWS","Más noticias");
define("_SHOPS_NOT_FOUND","No hay Tiendas");
define("_REVIEWS_NOT_FOUND","No hay Comentarios");
define("_PRODUCTS_NOT_FOUND","No hay Productos");
define("_GO_TO_SHOP","Visita la Tienda");
define("_DETAILS_VENDOR","Información de la Tienda");
define("_SOME_PRODUCTS","Algunos de Nuestros Productos");
define("HEADER_CREATE_ACCOUNT","Crea una Cuenta");
define("HEADER_SUBMIT_NEWS","Envia una Noticia");
define("HEADER_YOUR_ACCOUNT","Tu Cuenta");
define("HEADER_CONTENT","Contenidos");
define("HEADER_TOPICS","Argumentos");
define("HEADER_ALL_TOPICS","Todos Argumentos");
define("HEADER_WELCOME","Bienvenido a");
define("HEADER_SLOGAN","Sistema de Gestión de Contenidos (CMS) <br>&nbsp;&nbsp;&nbsp;&nbsp;y Multi-Tienda e-Commerce");
define("_SELECT_VENDOR","Elige la Tienda");
define("_SELECT_CATEGORY","Elige Categoria");
define("_VENDORS_NOT_FOUND","No hay Tiendas");
define("_CATEGORIES_NOT_FOUND","No hay Categorias");
define("_PRODUCTS_NOT_FOUND","No hay Productos");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","Software Libre");
define("_LAST10DOWNLOAD","ultimas 10 Descargas");
define("_SITE_PREFERENCES","Preferencias por el ");
define("_VENDORS","Tiendas");
define("_OUR_SHOPS","Las Nuestras Tiendas");
define("_PRODUCTS","Productos");
define("_CATEGORIES_PRODUCTS","Categorias");
define("_DETAILS_PROD","Particolares del Producto");
define("_PRODUCT_RANDOM","Un Producto Cualquiera");
define("_DEVELOPMENT","Desarrollo");
define ("_TEXT_NEWS", "<center><b>Desarrollo del Proyecto</b></center><p>En esta pagina hay noticias sobre nuevos modulos, bloques, funcionalidades y lo que pertenece al desarrollo del proyecto.</p>");
define("_SELECTCURRENCY","Elige la Moneda");
