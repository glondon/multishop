...
$author_name = "Francisco Burzi & NukeScripts Network, with changes for Php-MultiShop by Piero Trono";
...
$module_version = "1.0";
$module_description = "Create Account, Login, Change Personal Option, ...";
