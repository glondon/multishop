...
define("_ADDRESS_BOOK","Libro indirizzi");
define("_LAST10SUBMISSION","ultime 10 notizie");
define("_FIRST_NAME","Nome");
define("_LAST_NAME","Cognome");
define("_COMPANY","Società");
define("_STREET_ADDRESS","via/piazza");
define("_SUBURB","Suburbano");
define("_POST_CODE","Codice Postale");
define("_CITY","Città");
define("_STATE_PROVINCE","Provincia");
define("_COUNTRY","Stato");
define("_TELEPHONE","Telefono");
define("_GENDER","Sesso");
define("_DATE_OF_BIRTH","Data di nascita");
define("_REQUIRED_INFORMATION","Non hai inserito tutte le informazioni personali necessarie per poter acquistare presso i nostri negozi. Puoi tornare <a href=\"javascript:history.go(-1)\"><b>indietro</b></a> per completarle correttamente. Gli errori riguardano i seguenti campi:");
define("_INFORMATION_FOR_SHOPPING", "Informazioni Personali (richieste per l'acquisto)");
define("_INFOSHOP", "Dati per lo Shopping");
