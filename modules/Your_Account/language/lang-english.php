...
define("_LAST10SUBMISSION","10 last submissions");
define("_FIRST_NAME","First Name");
define("_LAST_NAME","Last Name (Surname)");
define("_COMPANY","Company");
define("_STREET_ADDRESS","Street Address");
define("_SUBURB","Suburban");
define("_POST_CODE","Post Code");
define("_CITY","City");
...
define("_REQUIRED_INFORMATION","The required Personal Information for shopping was not completed correctly. Please <a href=\"javascript:history.go(-1)\"><b>go back</b></a> and correct any mistakes.");
define("_INFORMATION_FOR_SHOPPING", "Personal Information (required for shopping)");
define("_INFOSHOP", "Personal Datas for Shopping");
