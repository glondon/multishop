...
define("_ADDRESS_BOOK","Address Book");
define("_LAST10SUBMISSION","10 dernières propositions");
define("_FIRST_NAME","Prénom");
define("_LAST_NAME","NOM (Surnom)");
define("_COMPANY","Société");
define("_STREET_ADDRESS","Adresse");
define("_SUBURB","Arrondissement");
define("_POST_CODE","Code Postal");
define("_CITY","Ville");
define("_STATE_PROVINCE","State/Province");
define("_COUNTRY","Pays");
define("_TELEPHONE","Téléphone");
define("_GENDER","Genre");
define("_DATE_OF_BIRTH","Date de naissance");
define("_REQUIRED_INFORMATION","Les informations personnelles requises pour les achats ne sont pas complétées correctement. SVP <a href=\"javascript:history.go(-1)\"><b>revenir</b></a> et corriger les erreurs.");
define("_INFORMATION_FOR_SHOPPING", "Informations personnelles (indispensables pour les achats)");
define("_INFOSHOP", "Données personnelles pour les achats");
define("_PRIVACY", "Privé");
