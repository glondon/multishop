	...
	function LinksModLink($lid) {
		...
		while($row = $db->sql_fetchrow($result)) {
			...
			while($row4 = $db->sql_fetchrow($result4)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<tr><td valign=top bgcolor=$colorswitch>$ratinguser</td><td valign=top colspan=5 bgcolor=$colorswitch>$ratingcomments</td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=LinksDelComment&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
			...
			while($row7 = $db->sql_fetchrow($result7)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=LinksDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
				if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
				else $colorswitch=$bgcolor1;
			}
			...
			while($row8 = $db->sql_fetchrow($result8)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<tr><td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=LinksDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
				if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
				else $colorswitch=$bgcolor1;
			}
