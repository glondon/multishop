<?php
/*
  $Id: password_forgotten.php,v 1.3 2004/01/03 23:13:57 tropic Exp $
...
#============= // Php-MultiShop
      $cryptpass_nuke = md5($new_password);
      
      tep_db_query("update ".PREFIX_DB_NUKE."_users set user_password = '" . tep_db_input($cryptpass_nuke) . "' where user_id = '" . (int)$check_customer['customers_id'] . "'");
#=============
