<?php
/*
  $Id: account_password.php,v 1.3 2004/01/03 23:14:31 tropic Exp $
...
#============= // Php-MultiShop
      $cryptpass_nuke = md5($password_new);
      
      tep_db_query("update ".PREFIX_DB_NUKE."_users set user_password = '" . tep_db_input($cryptpass_nuke) . "' where user_id = '" . (int)$customer_id . "'");
#=============
