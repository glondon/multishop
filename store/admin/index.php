<?php
/*
  $Id: index.php,v 1.4 2005/11/23 10:51:41 tropic Exp $
...
//Admin end
                     ...
                     'href' => tep_href_link(FILENAME_LANGUAGES, 'selected_box=localization'),
                     'children' => array(
#== // MultiShop
// commented the CURRENCIES link below (then removed the admin/currencies.php file)
//										 array('title' => BOX_LOCALIZATION_CURRENCIES, 'link' => tep_href_link(FILENAME_CURRENCIES, 'selected_box=localization')),
#== // 
...
#== // MultiShop
// commented the FILE_MANAGER link below (then removed the admin/file_manager.php file)
