<?php
/*
  $Id: espanol.php,v 1.1 2005/11/22 22:48:32 tropic Exp $
...
define('BOX_ADMINISTRATOR_MEMBERS', 'Groupos Membros');
define('BOX_ADMINISTRATOR_MEMBER', 'Membros');
define('BOX_ADMINISTRATOR_BOXES', 'Accesos File');
...
define('TEXT_INFO_EDIT_GROUP_INTRO','Introduction Modifica Grupos');
