<?php
/*
  $Id: admin_members.php,v 1.1 2005/11/23 11:32:45 tropic Exp $
...
define('TEXT_INFO_ERROR', '<font color="red">Indirizzo Email già usato!</font>');
...
define('ADMIN_EMAIL_TEXT', 'Ciao %s,' . "\n\n" . 'Puoi accedere al pannell odi amministrazione usando la seguente password. Una volta effettuato il login, cambia la tua password!' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Grazie!' . "\n" . '%s' . "\n\n" . 'Questa è una email inviata automaticamente, quindi non rispondere ad essa!'); 
define('ADMIN_EMAIL_EDIT_SUBJECT', 'Modifica profilo Membro Admin');
define('ADMIN_EMAIL_EDIT_TEXT', 'Ciao %s,' . "\n\n" . 'Le tue informazioni personali sono state modificate da un amministratore.' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Grazie!' . "\n" . '%s' . "\n\n" . 'Questa è una email inviata automaticamente, quindi non rispondere ad essa!'); 
...
define('TEXT_INFO_GROUPS_NAME_FALSE', '<font color="red"><b>ERRORE:</b> Il nome gruppo deve avere più di 5 caratteri!</font>');
define('TEXT_INFO_GROUPS_NAME_USED', '<font color="red"><b>ERRORE:</b> Nome gruppo già utilizzato!</font>');
...
define('TEXT_INFO_HEADING_DEFINE', 'Definisce Gruppo');
