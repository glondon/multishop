<?php
/*
  $Id: install_2.php,v 1.6 2005/11/22 21:43:23 tropic Exp $
...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    <td>
      ...
      <p>Note: the file used for the import is
      <br><?php echo $dir_fs_www_root . 'install/<b>oscommerce.sql</b>'; ?></p>
    </td>
  </tr>
</table>
...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    ...
    <td width="70%" class="smallDesc">
      ...
      <div id="dbHost" class="longDescription">The database server can be in the form of a hostname, such as localhost, or db1.myserver.com, or as an IP-address, such as 192.168.0.1</div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="30%" valign="top">Prefix Store:</td>
    <td width="70%" class="smallDesc">
      <input type="text" name="prefix" value="<? echo $prefix; ?>" readonly style="color: #888888;"> 
      <img src="images/layout/help_icon.gif" onClick="toggleBox('dbPrefix');"><br>
      <div id="dbPrefixSD">Prefix Store</div>
      <div id="dbPrefix" class="longDescription">This is the PREFIX for this store choosed at the start of installation.</div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo osc_draw_radio_field('STORE_SESSIONS', 'mysql', true); ?>&nbsp;Database&nbsp;&nbsp;<?php echo osc_draw_radio_field('STORE_SESSIONS', 'files'); ?>&nbsp;Files&nbsp;&nbsp;&nbsp;
      <img src="images/layout/help_icon.gif" onClick="toggleBox('dbSess');"><br>
      <div id="dbSessSD"></div>
      <div id="dbSess" class="longDescription">Store user session data in database or as files on the server.<br>Note: Due to security related issues, database session storage is recommended for shared servers.</td></div>
    </td>
  </tr>
</table>
