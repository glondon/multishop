<?php
/*
  $Id: install_7.php,v 1.3 2005/05/29 15:13:21 tropic Exp $
...
<?php
  ...
  if ($db_error == false) {
    osc_db_test_connection($db['DB_DATABASE'], $db['DB_PREFIX']);
  }
...
<?php
    ...
    $file_contents = '<?php' . "\n" .
                     ...
                     '  define(\'DOMAIN_MULTISHOP\', \'http://www.mymultishop.com/index.php\'); // e.g. www.mymultishop.com' . "\n" .
                     '  define(\'NAME_MULTISHOP\', \'Multi-Shop\'); // your virtual mall name' . "\n".
                     '  define(\'STORE_PREFIX\', \'' . $db['DB_PREFIX'] .'\'); // prefix for the store' . "\n".
                     '  $sitekey = "SdFk*fa28367-dm56w69.3a2fDS+e9"; // the sitekey of the platform (PhpNuke)' . "\n".
                     '' . "\n" .
                     '' . "\n" .
...
<p>The configuration was <b>successful !</b>
<br>
Now, you must create the first <font class="pageTitle">Admin-Account</font> for this store.</p>

<form name="install" action="install.php?step=8" method="post">
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    <td width="30%" valign="top">Email Address:</td>
    <td width="70%" class="smallDesc">
      <input type="text" name="admin_email_address" size="30">
    </td>
  </tr>
  <tr>
