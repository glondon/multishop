	...
	function main_ban($ip=0) {
		...
		if ($numrows != 0) {
			...
			while ($row = $db->sql_fetchrow($result)) {
				...
				."<td bgcolor=\"$bgcolor2\" align='center'><font class=\"content\"><a href=\"".$admin_file.".php?op=ipban_delete&id=".intval($row['id'])."&ok=0\"><img src=\"images/unban.gif\" width=\"15\" height=\"15\" border=\"0\" alt=\""._UNBAN."\" title=\""._UNBAN."\"></a></td></tr>";
			}
			echo "</table>";
			CloseTable();
		}
