...
/**************************************************************************/
/* $Id: lang-english.php,v 1.1.1.1 2005/11/21 13:48:02 tropic Exp $ */
...
define("HEADER_CREATE_ACCOUNT","Create an Account");
define("HEADER_SUBMIT_NEWS","Submit News");
define("HEADER_YOUR_ACCOUNT","Your Account");
define("HEADER_CONTENT","Content");
define("HEADER_TOPICS","Topics");
define("HEADER_ALL_TOPICS","All Topics");
define("HEADER_WELCOME","Welcome to");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Vendors");
define("_SELECT_VENDOR","Select a Store");
define("_SELECT_CATEGORY","Select a Category");
define("_VENDORS_NOT_FOUND","Stores not found");
define("_CATEGORIES_NOT_FOUND","Categories not found");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","Free Software");
define("_LAST10DOWNLOAD","last 10 Download");
define("_SITE_PREFERENCES","Site Preferences for ");
define("_VENDORS","Stores");
define("_OUR_SHOPS","The Our Stores");
define("_PRODUCTS","Products");
define("_CATEGORIES_PRODUCTS","Categories");
define("_DETAILS_PROD","About this Product");
define("_PRODUCT_RANDOM","A Product at Random");
define("_DEVELOPMENT","Development");
define ("_TEXT_NEWS", "<center><b>Development of the Project</b></center><p>This page is for the news about the development of the project: modules, blocks, functionalities, etc... .</p>");
define("_SELECTCURRENCY","Select a Currency");
