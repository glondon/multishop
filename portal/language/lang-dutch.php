...
/* Kyoshi Peter Vermeeren                */
/* http://kamikaze-portal.com/budoshop   */
/*****************************************/
...
define("_READ_MORE_NEWS","Lees meer News");
define("_REVIEWS_NOT_FOUND","Reviews niet gevonden");
define("_SHOPS_NOT_FOUND","Geen verkooppunten gevonden");
define("_GO_TO_SHOP","Ga naar de winkel");
define("_DETAILS_VENDOR","Over deze winkel");
define("_SOME_PRODUCTS","Enkele van onze producten");
define("HEADER_CREATE_ACCOUNT","Maak een account aan ");
define("HEADER_SUBMIT_NEWS","Stuur je nieuws in");
define("HEADER_YOUR_ACCOUNT","Je persoonlijke account");
define("HEADER_CONTENT","Inhoud");
define("HEADER_TOPICS","Hoofdstukken");
define("HEADER_ALL_TOPICS","Alle hoofdstukken");
define("HEADER_WELCOME","Welkom bij");
define("HEADER_SLOGAN","Inhoudelijk Beheerssysteem Systeem &amp; e-Commerce Multi-Verkooppunten");
define("_SELECT_VENDOR","Kies een verkooppunt");
define("_SELECT_CATEGORY","Kies een categorie");
define("_VENDORS_NOT_FOUND","Verkooppunten niet gevonden");
define("_CATEGORIES_NOT_FOUND","Categorieën niet gevonden");
define("_PRODUCTS_NOT_FOUND","Producten niet gevonden");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","Gratis Software");
define("_LAST10DOWNLOAD","laatste 10 Downloads");
define("_SITE_PREFERENCES","Site Voorkeuren voor ");
define("_VENDORS","Verkooppunten");
define("_OUR_SHOPS","Onze verkooppunten");
define("_PRODUCTS","Producten");
define("_CATEGORIES_PRODUCTS","Categorieën");
define("_DETAILS_PROD","Over dit product");
define("_PRODUCT_RANDOM","Een willekeurig product");
define("_DEVELOPMENT","Ontwikkeling");
define ("_TEXT_NEWS", "<center><b>Project ontwikkeling </b></center><p>Op deze pagina vind je het laatste nieuws betreffende de ontwikkeling van, blocks, functionaliteit, enz... .</p>");
define("_SELECTCURRENCY","Kies een munt");
