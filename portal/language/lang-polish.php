...
define("_READ_MORE_NEWS","wiêcej newsów");
define("_REVIEWS_NOT_FOUND","opis nieznaleziony");
define("_SHOPS_NOT_FOUND","sklep nieznaleziony");
define("_PRODUCTS_NOT_FOUND","produkt nieznaleziony");
define("_GO_TO_SHOP","przejd¼ do sklepu");
define("_DETAILS_VENDOR","informacje o sklepie");
define("_SOME_PRODUCTS","wybrane produkty");
define("HEADER_CREATE_ACCOUNT","utwórz konto");
define("HEADER_SUBMIT_NEWS","dodaj newsa");
define("HEADER_YOUR_ACCOUNT","Twoje konto");
define("HEADER_CONTENT","zawarto¶æ");
define("HEADER_TOPICS","temat");
define("HEADER_ALL_TOPICS","wszystkie tematy");
define("HEADER_WELCOME","Witamy w");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Shop");
define("_SELECT_VENDOR","wybierz sklep");
define("_SELECT_CATEGORY","wybierz kategoriê");
define("_VENDORS_NOT_FOUND","Sklep nieznaleziony");
define("_CATEGORIES_NOT_FOUND","kategorie nieznalezione");
define("_PRODUCTS_NOT_FOUND","Products Not Found");
define("_HOME_DEMO","Home Demo");
define("_FREE_SOFTWARE","oprogramowanie bezp³atne");
define("_LAST10DOWNLOAD","ostatnie 10 pobrañ");
define("_SITE_PREFERENCES","Ustawienia strony dla ");
define("_VENDORS","sklepy");
define("_OUR_SHOPS","Nasz Sklep");
define("_PRODUCTS","produkty");
define("_CATEGORIES_PRODUCTS","kategorie");
define("_DETAILS_PROD","info o produkcie");
define("_PRODUCT_RANDOM","przyk³adowy produkt");
define("_DEVELOPMENT","Zarz±dzanie");
define ("_TEXT_NEWS", "<center><b>Zarz±dzanie Projektem</b></center><p>Strona przeznaczona dla newsów projektu: modu³ów, bloków, funkcjonalno¶ci, etc... .</p>");
define("_SELECTCURRENCY","wybierz walutê");
