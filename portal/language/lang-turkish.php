...
define("_READ_MORE_NEWS","Daha fazla haberler oku");
define("_REVIEWS_NOT_FOUND","Dergiler bulunamadý");
define("_SHOPS_NOT_FOUND","Marketler bulunamadý");
define("_PRODUCTS_NOT_FOUND","Ürünler bulunamadý");
define("_GO_TO_SHOP","Markete git");
define("_DETAILS_VENDOR","Bu market hakkýnda");
define("_SOME_PRODUCTS","Bizim bazý ürünlerimiz");
define("HEADER_CREATE_ACCOUNT","Raporlarý oluþtur");
define("HEADER_SUBMIT_NEWS","Haberleri sun");
define("HEADER_YOUR_ACCOUNT","Senin raporlarýn");
define("HEADER_CONTENT","Ýçerik");
define("HEADER_TOPICS","Konular");
define("HEADER_ALL_TOPICS","Bütün Konular");
define("HEADER_WELCOME","Hoþgeldiniz");
define("HEADER_SLOGAN","Ýþletme sisteminin içerikleri &amp; e-Ticaret Multi-Satýcýlar");
define("_SELECT_VENDOR","Bir market seçin");
define("_SELECT_CATEGORY","Bir kategori seçin");
define("_VENDORS_NOT_FOUND","Satýcýlar bulunamadý.");
define("_CATEGORIES_NOT_FOUND","Kategoriler bulunamadý.");
define("_PRODUCTS_NOT_FOUND","Ürünler bulunamadý.");
define("_HOME_DEMO","Ana Demo");
define("_FREE_SOFTWARE","Ücretsiz bilgisayar yazýlýmý");
define("_LAST10DOWNLOAD","Geçmiþ 10 Download");
define("_SITE_PREFERENCES","Site için tercihler ");
define("_VENDORS","Marketler");
define("_OUR_SHOPS","Bizim marketler");
define("_PRODUCTS","Ürünler");
define("_CATEGORIES_PRODUCTS","Kategoriler");
define("_DETAILS_PROD","Bu ürünler hakkýnda");
define("_PRODUCT_RANDOM","Rastgelede ürün");
define("_DEVELOPMENT","Geliþme");
define ("_TEXT_NEWS", "<center><b>Projenin geliþimi </b></center><p>Bu sayfa projenin geliþimi hakýndaki haberler için: modüller,bloklar,iþlevsellikler,vb... .</p>");
define("_SELECTCURRENCY","Bir para türü seçin");

/*******************************/
/* original Php-Nuke variables */
/*******************************/
