...
/* Translation in swedish by               */
/* Tom Makela - http://zenit.buy2trade.com */
/*******************************************/
...
define("_READ_MORE_NEWS","Läs mer News");
define("_REVIEWS_NOT_FOUND","Reviews ej funna");
define("_SHOPS_NOT_FOUND","Butiker ej funna för denna kategori");
define("_PRODUCTS_NOT_FOUND","Produkter ej funna");
define("_GO_TO_SHOP","Gå till butik");
define("_DETAILS_VENDOR","Om denna butik");
define("_SOME_PRODUCTS","Några av våra Produkter");
define("HEADER_CREATE_ACCOUNT","Skapa nytt Konto");
define("HEADER_SUBMIT_NEWS","Skicka in Nyheter");
define("HEADER_YOUR_ACCOUNT","Kontoinformation");
define("HEADER_CONTENT","Innehåll");
define("HEADER_TOPICS","Ämnen");
define("HEADER_ALL_TOPICS","Alla Ämnen");
define("HEADER_WELCOME","Välkommen till");
define("HEADER_SLOGAN","Content Management System &amp; e-Commerce Multi-Vendors");
define("_SELECT_VENDOR","Välj en butik");
define("_SELECT_CATEGORY","Välj en kategori");
define("_VENDORS_NOT_FOUND","Butiker ej funna");
define("_CATEGORIES_NOT_FOUND","Kategorier ej funna");
define("_PRODUCTS_NOT_FOUND","Produkter ej funna");
define("_HOME_DEMO","Hem Demo");
define("_FREE_SOFTWARE","Gratis program");
define("_LAST10DOWNLOAD","Senaste 10 nerladdningarna");
define("_SITE_PREFERENCES","Website Inställningar för ");
define("_VENDORS","Butiker");
define("_OUR_SHOPS","Våra butiker");
define("_PRODUCTS","Produkter");
define("_CATEGORIES_PRODUCTS","Kategorier");
define("_DETAILS_PROD","Om denna Produkt");
define("_PRODUCT_RANDOM","Slumpmässig Produkt");
define("_DEVELOPMENT","Utveckling");
define ("_TEXT_NEWS", "<center><b>Utvecklingen av detta Projekt</b></center><p>Denna sida är för information om utveclkingan av projektet: moduler, block, funktionalitet, etc... .</p>");
define("_SELECTCURRENCY","Välj Valuta");
