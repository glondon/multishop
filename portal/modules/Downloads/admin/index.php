	...
	function DownloadsModDownload($lid) {
		...
		while($row = $db->sql_fetchrow($result)) {
			...
			if ($recordexist == 0) {
				...
				."" . _EDITORIALTEXT . ":<br><textarea name=\"editorialtext\" cols=\"70\" rows=\"15\"></textarea><br>"
				...
				while($row3 = $db->sql_fetchrow($resulted2)) {
					...
					."</select><input type=\"hidden\" name=\"op\" value=\"DownloadsModEditorial\"><input type=\"submit\" value=\"" . _MODIFY . "\"> [ <a href=\"".$admin_file.".php?op=DownloadsDelEditorial&amp;downloadid=$lid\">" . _DELETE . "</a> ]</form>";
				}
			}
			CloseTable();
			echo "<br>";
			...
			echo "<tr><td width=20 colspan=1><b>User  </b></td><td colspan=5><b>Comment  </b></td><td><b><center>Delete</center></b></td></tr>";
			...
			while($row4 = $db->sql_fetchrow($result4)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<tr><td valign=top bgcolor=$colorswitch>$ratinguser</td><td valign=top colspan=5 bgcolor=$colorswitch>$ratingcomments</td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=DownloadsDelComment&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
			...
			echo "<tr><td><b>User  </b></td><td><b>IP Address  </b></td><td><b>Rating  </b></td><td><b>User AVG Rating  </b></td><td><b>Total Ratings  </b></td><td><b>Date  </b></td></font></b><td><b><center>Delete</center></b></td></tr>";
			...
			echo "<tr><td colspan=2><b>IP Address  </b></td><td colspan=3><b>Rating  </b></td><td><b>Date  </b></font></td><td><b><center>Delete</center></b></td></tr>";
			...
			while($row7 = $db->sql_fetchrow($result7)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=DownloadsDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
				if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
				else $colorswitch=$bgcolor1;
			}
			...
			echo "<tr><td colspan=2><b>IP Address  </b></td><td colspan=3><b>Rating  </b></td><td><b>Date  </b></td></font></b><td><b><center>Delete</center></b></td></tr>";
			...
			while($row8 = $db->sql_fetchrow($result8)) {
				...
				$timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
				$formatted_date = date("F j, Y", $timestamp);
				echo "<tr><td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a href=".$admin_file.".php?op=DownloadsDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr>";
				$x++;
				if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
				else $colorswitch=$bgcolor1;
			}
