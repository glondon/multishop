...
/************************************************************************/
/* $Id: footer.php,v 1.1.1.1 2005/11/21 13:47:29 tropic Exp $ */
...
function footmsg() {
	global  $multishop_copyright, $foot1, $foot2, $foot3, $copyright, $total_time, $start_time, $commercial_license, $footmsg;
	$mtime = microtime();
	$mtime = explode(" ",$mtime);
	...
	// YOU'RE NOT ALLOWED TO REMOVE NOR EDIT THIS WITHOUT A WRITTEN PERMISSION BY Piero Trono
	// READ THE COPYRIGHT POLICY FOR FURTHER DETAILS: http://php-multishop.com/copyright-policy.php
	$footmsg .= $multishop_copyright . "<br>\n";
